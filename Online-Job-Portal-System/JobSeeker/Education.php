                  ...
                  <tr>
                    <td><form id="form1" method="post" action="InsertEdu.php">
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td class="trcolorb"><strong>Degree:</strong></td>
                          <td class="trcolorb">
                        ...
                        <tr>
                          <td class="trcolorb"><strong>Other Degree:</strong></td>
                          <td class="trcolorb"><label>
                            <input type="text" name="txtOther" id="txtOther" />
                          </label></td>
                        </tr>
                        <tr>
                          <td class="trcolorb"><strong>University/Board Name:</strong></td>
                          <td class="trcolorb"><span id="sprytextfield1">
                            <label>
                        ...
                        <tr>
                          <td class="trcolorb"><strong>Passing Year:</strong></td>
                          <td class="trcolorb"><label>
                        ...
                        <tr>
                          <td class="trcolorb"><strong>Percentage(%)</strong></td>
                          <td class="trcolorb"><span id="sprytextfield2">
                            <label>
