        ...
        <div id="content">
            ...
            <div class="article" style="font-family: book antiqua; font-size: 14px">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td bgcolor="#A0B9F3" style="font-size: 16px"><strong>Give Your Feedback</strong></td>
                  </tr>
                  <tr>
                    <td><form id="form1" method="post" action="InsertFeedback.php">
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td style="font-size: 17px">Feedback:</td>
                          <td><span id="sprytextarea1">
                            <label>
                            <textarea name="txtFeedback" style="font-size: 17px" id="txtFeedback" cols="35" rows="5"></textarea>
                            </label>
